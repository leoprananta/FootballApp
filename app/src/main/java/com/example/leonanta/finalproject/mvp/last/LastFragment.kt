...
class LastFragment : Fragment(), LastView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val fragmentView = inflater.inflate(R.layout.fragment_last, main_container, false)

        setHasOptionsMenu(true)

        val spinner = fragmentView.findViewById<Spinner>(R.id.last_spinner)
        progressBar = fragmentView.findViewById(R.id.last_progBar)
        recyclerView = fragmentView.findViewById(R.id.last_recyclerView)
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                when (leagueId) {
                    ...
                    "English League Championship" -> presenter.getLastMatch("4329")
                    "Scottish Premier League" -> presenter.getLastMatch("4330")
                    ...
                    "Greek Superleague Greece" -> presenter.getLastMatch("4336")
                }
            }
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                if (newText.toString().isEmpty()) {
                    leagueId = last_spinner.selectedItem.toString()
